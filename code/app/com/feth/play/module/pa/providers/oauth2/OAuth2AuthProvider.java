...
name|warn
argument_list|(
literal|"Cache either timed out, or you are using a setup with multiple servers and a non-shared cache implementation"
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// the return callback may have been forged
throw|throw
operator|new
name|AuthException
argument_list|(
